...
export default function Footer() {
  ...
  const footerLinks = {
    servicos: [
      { name: 'SEO Técnico BH', href: '/servicos/seo-bh' },
      { name: 'Desenvolvimento Web', href: '/servicos/desenvolvimento-web-bh' },
      { name: 'Marketing Digital', href: '/servicos/marketing' },
      { name: 'Tráfego Pago', href: '/servicos/trafego-pago-bh' },
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/orbeelabs',
      icon: (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/orbeelabs',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center text-xl hover:bg-primary/20 hover:text-primary transition-all duration-300"
                  title={social.name}
                >
                  {social.icon}
                </motion.a>
          ...
          <motion.div
            ...
            className="lg:col-span-3"
          >
            <h3 className="text-lg font-bold text-white mb-6">Recursos</h3>
            <ul className="space-y-3">
